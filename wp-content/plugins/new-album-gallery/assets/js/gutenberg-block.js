        ...
        edit: function(props) {
            ...
            if (attributes.galleryId) {
                ...
                editorContent = el('div', { style: { pointerEvents: 'none', display: 'flow-root' } },
                    el(Disabled, {},
                        el(ServerSideRender, {
                            block: 'new-album-gallery/album-gallery-block',
                ...
                editorContent = el('div', {
                    ...
                    el('h4', { style: { margin: '0 0 10px 0', fontSize: '16px', fontWeight: '700', color: '#ffffff' } }, 'Album Gallery Block'),
                    el('p', { style: { margin: '0 0 16px 0', opacity: 0.85, fontSize: '13px', color: '#c084fc' } }, 
                        'Select an album gallery to display.'
                    ),
